...
public class LocalPoliceFormB extends JFrame implements Observer {
    ...
    private final String localPoliceName = "localPoliceRequestB";
    private LocalPoliceGateway gateway = new LocalPoliceGateway("Eindhoven", "LocalPoliceReplyB", localPoliceName);

    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    LocalPoliceFormB form = new LocalPoliceFormB();
    ...
    public LocalPoliceFormB() {
        setTitle("Local Police B");
