...
public class LocalPoliceFormC extends JFrame implements Observer {
    ...
    private final String localPoliceName = "localPoliceRequestC";
    private LocalPoliceGateway gateway = new LocalPoliceGateway("Veldhoven", "LocalPoliceReplyC", localPoliceName);

    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    LocalPoliceFormC form = new LocalPoliceFormC();
    ...
    public LocalPoliceFormC() {
        setTitle("Local Police C");
